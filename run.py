...
def make_shell_context():
    return {'db':db, 'Course': Course, 'SkillLevel': SkillLevel, 'CourseCategory':CourseCategory, 'Account': Account, 'CourseTag': CourseTag, 'CourseLearningObjectives': CourseLearningObjectives}
